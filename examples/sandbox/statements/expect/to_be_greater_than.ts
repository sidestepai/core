/**
 * `s.expect.to_be_greater_than` — codegen'd declarative statement.
...
export const expectToBeGreaterThan = workflowTest({
  name: "ex_expect_to_be_greater_than",
  stack: [
    s.expect.to_be_greater_than({}),
  ],
});
