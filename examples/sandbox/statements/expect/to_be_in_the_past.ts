/**
 * `s.expect.to_be_in_the_past` — codegen'd declarative statement.
...
export const expectToBeInThePast = workflowTest({
  name: "ex_expect_to_be_in_the_past",
  stack: [
    s.expect.to_be_in_the_past({}),
  ],
});
