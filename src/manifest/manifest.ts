...
export function renderLlmsTxt(m: Manifest): string {
  ...
  lines.push(
    ...
    "  `table/trigger/`, `agent/trigger/`), every table in `table/table.ts`, settings",
