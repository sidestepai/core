...
const CLI_COMMANDS: readonly ManifestCliCommand[] = [
  ...
  },
  {
    ...
    args: "[<path>] [--workspace <id>] [--path <path>|-] [--name <name>] [--ai <preset>] [--force] [--no-install] [--no-verify]",
    flags: [
