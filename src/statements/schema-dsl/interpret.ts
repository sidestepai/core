...
import { assertLambdaStatement } from "../../values/lambda.js";
...
export function encodeFromSpec(spec: StatementSpec, authored: Authored): Statement {
  // A statement carrying a JavaScript body gets that body checked against the
  // bindings its surface actually injects, before it can reach a live request
  // (issue #221). No-op for every other statement.
